...
namespace imbACE.Services.application
{
    ...
    using imbACE.Services.platform.cache;
    ...
    public abstract class aceApplicationBase : IAceApplicationBase, IAceLogable
    {
        ...
        protected void startUpProcess(String[] args, ILogBuilder _logger)
        {
            ...
            folder_cache = folder.Add(FOLDERNAME_CACHE, "Cache", "Repository of [" + name + "] application general cache");
            folder_reports = folder.Add(FOLDERNAME_REPORTS, "Reporting output", "Repository with reports generated by [" + name + "] application");
            folder_resources = folder.Add(FOLDERNAME_RESOURCES, "Resources", "Repository with resources used by [" + name + "] application");
            folder_config = folder.Add(FOLDERNAME_CONFIG, "Configuration", "Application [" + name + "] configuration files");
            folder_plugins = folder.Add(FOLDERNAME_PLUGINS, "Plug-ins", "Directory with 3rd party plug-ins for application [" + name + "]. Use subdirectories to organize plug-ins into groups.");
            folder_projects = folder.Add(FOLDERNAME_PROJECTS, "Projects", "Directory with 3rd party plug-ins for application [" + name + "]. Use subdirectories to organize plug-ins into groups.");
            folder_logs = folder.Add(FOLDERNAME_LOGS, "Logs", "Diagnostic data for [" + name + "] application.");
