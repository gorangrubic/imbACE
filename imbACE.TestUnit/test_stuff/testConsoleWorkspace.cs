...
namespace imbACE.TestUnit.test_stuff
{
    ...
    public class testConsoleWorkspace : aceAdvancedConsoleWorkspace
    {


        /// <summary>
        /// Initializes the workspace for the testConsole console 
        /// </summary>
        /// <param name="console">The console using this workspace</param>
        public testConsoleWorkspace(testConsoleConsole console) : base(console)
        {
